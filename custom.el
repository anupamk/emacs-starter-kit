...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "M+ 1mn" :foundry "M+  " :slant normal :weight normal :height 113 :width normal))))
 ...
 '(mu4e-contact-face ((t (:foreground "goldenrod"))))
 '(mu4e-header-highlight-face ((t (:background "gray28" :weight normal))))
 '(mu4e-header-key-face ((t (:foreground "gray45" :weight bold))))
 '(mu4e-header-value-face ((t (:foreground "gray"))))
 '(mu4e-unread-face ((t (:foreground "gold3"))))
 '(show-paren-match ((t (:background "gray26" :weight normal)))))
